return function(ctx)
	...
	local REGISTRY = {
		...
		Leviathan = {
			AdapterKey = "Leviathan",
			FeatureKey = "LeviathanFeature",
		},
		Mage = {
			AdapterKey = "Mage",
			FeatureKey = "MageFeature",
		},
		MageOfLight = {
			AdapterKey = "MageOfLight",
			FeatureKey = "MageOfLightFeature",
		},
		MageOfShadows = {
		...
		Paladin = {
			AdapterKey = "Paladin",
			FeatureKey = "PaladinFeature",
		},
		Starbreaker = {
			AdapterKey = "Starbreaker",
			FeatureKey = "StarbreakerFeature",
		},
		Stormcaller = {
